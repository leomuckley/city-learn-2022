...
How to get robust learning in continous spaces?


Uses max entropy, scale cost function to encourage exploration


Total rewards in time -> smooth variation


Network to handle the policy

Ouput the mean, std -> sample to get actions

Critic: action good or bad?
...
class CriticNetwork(nn.Module):
    ...
    def __init__(self, beta, input_dims, n_actions, fc1_dims=256, fc2_dims=256, name='critic', chkpt_dir='tmp/sac'):
        ...
        ## Critic evaluates the (s,a) pair from the begining
...
class ValueNetwork(nn.Module):
    ...
    def __init__(self, beta, input_dims, fc1_dims=256, fc2_dims=256, name='value', chkpt_dir='tmp/sac'):
        ...
        self.fc2 = nn.Linear(self.fc1_dims, self.fc2_dims)
        self.v = nn.Linear(self.fc2_dims, 1) # Scalar
...
class ActorNetwork(nn.Module):
    ...
    Max action is the greatest value that the action can take.
    TanH is bound by (-1, 1) so the max action value scales these values.
    ...
    def __init__(self, alpha, input_dims, max_action, fc1_dims=256, fc2_dims=256, n_actions=2, name='actor', chkpt_dir='tmp/sac'):
        ...
        self.reparam_noise = 1e-6 # for Log of 0
